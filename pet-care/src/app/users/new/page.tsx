  ...
  return (
    <div className='NewUserPage bg-gradient-to-r from-[#C5E3E9] to-[#F9FCFD] bg-opacity-25 p-5 min-h-[70vh] text-petCare-sapphireTeal-dark'>
        <div className='flex flex-col items-center'>
            <h1 className='text-3xl font-bold'>Välkommen till oss på PetCare</h1>
            <h2 className=''>För att kunna ta hand om dig och din {currentSelectedPet} på bästa sätt behöver du fylla i några uppgifter</h2>
        </div>
        ...
        <div className='FormBox m-10 p-10 bg-petCare-myWhite'>
            <div className='flex flex-col gap-10 md:flex-row justify-evenly'>
                ...
                <div className='md:w-1/2'>
                    <h1 className=' text-2xl font-bold mb-5'>Uppgifter om ditt husdjur</h1>
                    <RegisterPetForm/>
                </div>
            </div>
