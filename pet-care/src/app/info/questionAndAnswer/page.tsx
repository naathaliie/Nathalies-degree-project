  ...
  return (
    <>
      <div className="bg-gradient-to-r from-[#C5E3E9] to-[#F9FCFD] bg-opacity-25 flex flex-col items-center">
        <div className="w-full px-3 sm:px-0 sm:w-3/4 h-20 sm:h-36 flex flex-col justify-center text-petCare-sapphireTeal-dark">
        ...
        <div className="w-full sm:w-3/4 bg-petCare-myWhite rounded-lg sm:px-10 pb-10 pt-5 m-2 h-auto text-petCare-sapphireTeal-dark">
          <div>
