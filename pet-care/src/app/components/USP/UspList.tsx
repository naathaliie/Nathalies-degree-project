...
const UspList = () => {
  ...
  return (
    <div className=" w-full bg-petCare-myWhite py-20 sm:px-16 text-petCare-sapphireTeal-dark flex justify-center items-center gap-12 md:gap-7 flex-col md:flex-row flex-wrap">
