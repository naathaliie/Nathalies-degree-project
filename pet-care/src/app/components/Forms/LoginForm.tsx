...
const LoginForm = () => {
  ...
  return (
    <form
      onSubmit={submit}
      className="FormContainer flex flex-col gap-5 bg-zinc-100 border-2 border-petCare-sapphireTeal-dark rounded-md p-10 sm:w-[40%] "
    >
      ...
      <div className=" self-center">{/* <ActionBtn title="Logga in"/> */}</div>
    </form>
  );
};
